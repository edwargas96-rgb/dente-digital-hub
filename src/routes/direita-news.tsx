...
function DireitaNewsPage() {
  ...
  // Meta Pixel — injeção do script uma única vez
  useEffect(() => {
    if (typeof window === "undefined") return;
    if (document.getElementById("meta-pixel-loader")) return;
    const s = document.createElement("script");
    s.id = "meta-pixel-loader";
    s.text =
      "!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','1389109309993259');fbq('track','PageView');";
    (document.head || document.documentElement).appendChild(s);
    const img = document.createElement("img");
    img.height = 1;
    img.width = 1;
    img.style.display = "none";
    img.src = "https://www.facebook.com/tr?id=1389109309993259&ev=PageView&noscript=1";
    img.alt = "";
